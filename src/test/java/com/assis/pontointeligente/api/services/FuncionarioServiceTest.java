...
import com.assis.pontointeligente.api.repositories.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	public void testBuscarFuncionarioPorEmail() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("email@mail.com");
		assertTrue(funcionario.isPresent());
	}
}
