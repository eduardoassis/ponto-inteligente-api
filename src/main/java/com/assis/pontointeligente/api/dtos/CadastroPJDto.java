...
public class CadastroPJDto {
	...
	@Length(min = 3, max = 200, message = "E-mail deve conter entre 5 e 200 caracteres.")
	...
	@Length(min = 3, max = 200, message = "Razão Social deve conter entre 5 e 200 caracteres.")
